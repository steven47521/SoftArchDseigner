...
class AgentStaticLoader implements AgentLoader {
	...
	public AgentStaticLoader(ReactAgent softArchDesignerAgent) {
		GraphRepresentation representation = softArchDesignerAgent.getAndCompileGraph()
				.stateGraph.getGraph(GraphRepresentation.Type.PLANTUML);
		System.out.println(representation.content());
		this.agents.put("softarch_designer", softArchDesignerAgent);
	}
